...
option_list = list(
  ...
  make_option("--methods", action = "store", default = 'lassosum2', type = "character",
              help="A subset of methods from C+T, lassosum2, and LDpred2, divided by comma [Optional]"),
  make_option("--trait", action = "store", default = NA, type = "character",
              help="The name of the trait being analyzed [Optional]"),
  ...
  make_option("--LDrefpanel", action = "store", default = '1kg', type = "character",
              help="LD reference panel. Options: '1kg' (1000 Genomes Project Phase 3) or 'ukbb' (UK Biobank, will be made available soon) [Optional]"),
